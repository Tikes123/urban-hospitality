...
import { Hotel, UtensilsCrossed, Wine, Users, Calendar, BarChart3, CheckCircle, Star } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[var(--brand-light)]/20 to-white">
      ...
      <main>
                ...
                <Card key={index}>
                  ...
                  <CardContent>
                    <div>
                      ...
                      <p className="text-sm text-[var(--brand)]">{testimonial.company}</p>
                    </div>
                  </CardContent>
                </Card>
              ))}
        ...
        <section className="py-16 px-4 bg-[var(--brand)] text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="secondary" className="bg-white text-[var(--brand)]" asChild>
                <Link href="/contact">Schedule Consultation</Link>
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="text-white border-white hover:bg-white hover:text-[var(--brand)] bg-transparent"
                asChild
              >
