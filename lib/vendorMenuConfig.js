...
export const VENDOR_MENU_ITEMS = [
  ...
  { menuKey: "outlet-type", label: "Outlet type", path: "/vendor/outlet-type" },
  { menuKey: "location", label: "Location", path: "/vendor/location" },
  { menuKey: "position", label: "Position", path: "/vendor/position" },
